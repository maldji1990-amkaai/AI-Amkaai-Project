    ...
    <main className="relative min-h-screen bg-[#030303] text-white flex flex-col items-center justify-center p-6 font-sans select-none">
      ...
      <div className="w-full max-w-md z-10 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-[10px] text-zinc-500 mt-1 font-mono uppercase tracking-widest">Create Your Access Node</p>
        </motion.div>
          ...
          <SignUp 
            ...
            appearance={{
              ...
              elements: {
                ...
                formButtonPrimary: "bg-gradient-to-r from-cyan-500 to-indigo-500 text-black font-black text-xs uppercase tracking-wider py-2.5 transition hover:opacity-90 rounded-xl border-0",
                formFieldLabel: "text-[10px] font-black font-mono uppercase tracking-wider text-zinc-400 mb-1",
                formFieldInput: "border border-white/5 bg-black/40 text-xs rounded-xl focus:border-cyan-500/40 text-white font-mono",
                footerActionText: "text-[11px] text-zinc-500",
